...
namespace GameDevS.Entities.Enemies
{
    internal class PatrolEnemy : Enemy
    {
        ...
        public PatrolEnemy(Vector2 position, float scale, int hitboxStartX, int hitboxStartY, int hitboxWidth, int hitboxHeight, IMovementController movementController) 
        ...
        public bool IsGroundAhead(CollisionManager2 collisionManager, PatrolEnemy enemy)
        {
